namespace Business.Validators
{
    ...
    internal abstract class LancamentoFinanceiroValidator
    {
        protected ILancamentoFinanceiroRepository Repository { get; }

        protected LancamentoFinanceiroValidator(ILancamentoFinanceiroRepository repository)
        {
